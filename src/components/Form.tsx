...
const Form: React.FC<FormProp> = ({
    ...
    const formatCoordinates = (val: number | undefined) => val ? val.toFixed(6) : '';
        ...
        <div className="flex flex-col h-full bg-white border-r border-gray-200 overflow-y-auto">
            <div className="p-6 space-y-8 flex-1">
                ...
                <div className="space-y-4">
                    ...
                    {mapProvider === 'google' && (
                        <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-3 mt-2">
                            <label className="block text-xs font-medium text-yellow-800 mb-1">Google API Key</label>
                            <input
                                type="password"
                                value={mapApiKey}
                ...
                <div className="space-y-5">
                    <div className="flex items-center justify-between">
                        ...
                        {isLoading && (
                            <span className="text-xs text-indigo-600 font-medium animate-pulse">Fetching address...</span>
                        )}
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs font-medium text-gray-500 mb-1 uppercase">City / Town</label>
                                <input
                                    type="text"
                                    readOnly
                            ...
                            <div>
                                <label className="block text-xs font-medium text-gray-500 mb-1 uppercase">Suburb</label>
                                <input
                                    type="text"
                                    readOnly
                        ...
                        <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-50">
                            <div>
                                <label className="block text-xs font-medium text-gray-400 mb-1 uppercase">Latitude</label>
                                <div className="relative">
                                    <input
                                        type="text"
                                        readOnly
                            ...
                            <div>
                                <label className="block text-xs font-medium text-gray-400 mb-1 uppercase">Longitude</label>
                                <div className="relative">
                                    <input
                                        type="text"
                                        readOnly
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50 text-center">
                <p className="text-[10px] text-gray-400">
                    {mapProvider === 'google' ? 'Powered by Google Maps Platform' : 'Powered by OpenStreetMap & Nominatim'}
                </p>
            </div>
        </div>
    )
